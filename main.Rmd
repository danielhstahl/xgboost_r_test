...
```{r data}
#test vs train
splitData=getTrainTest(cleanDataSet, "Gender")
#convert train to xgboost form
train=convertToMatrix(splitData$train, "Gender")
#convert test to xgboost form
test=convertToMatrix(splitData$test, "Gender")
```
